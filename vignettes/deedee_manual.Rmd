...
The App entails one tab for each of the above presented functions. The respective parameters can be set via self-explanatory input boxes in each tab and outputs are delivered in an interactive manner.
More information on the usage of each DeeDee function can be found in the `INFO` panel in each respective tab.
