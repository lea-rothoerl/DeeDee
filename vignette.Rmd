...
DeeDee_obj <- readRDS("~/Development/DeeDee_wip/tests/testdata_macrophage.RDS")
source("~/Development/DeeDee/R/deedee_venn.R", local = knitr::knit_global())
source("~/Development/DeeDee/R/deedee_upSet.R", local = knitr::knit_global())
source("~/Development/DeeDee/R/deedee_heatmap.R", local = knitr::knit_global())
source("~/Development/DeeDee/R/deedee_qq.R", local = knitr::knit_global())
source("~/Development/DeeDee/R/deedee_cat.R", local = knitr::knit_global())
source("~/Development/DeeDee/R/deedee_scatter.R", local = knitr::knit_global())
```
